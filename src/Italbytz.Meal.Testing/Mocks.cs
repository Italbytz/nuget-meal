...
namespace Italbytz.Meal.Testing
{
    public static class Mocks
    {
        public static List<IMeal> Dishes = new List<IMeal>() {
            new Italbytz.Meal.Abstractions.Meal() {
                ...
                Price = new Italbytz.Meal.Abstractions.Price() { Students = 1.0, Employees = 2.0, Pupils = 3.0, Others = 4.0 },
            ...
            new Italbytz.Meal.Abstractions.Meal() {
                ...
                Price = new Italbytz.Meal.Abstractions.Price() { Students = 5.0, Employees = 6.0, Pupils = 7.0, Others = 8.0 },
        ...
        public static List<IMeal> Desserts = new List<IMeal>() {
            new Italbytz.Meal.Abstractions.Meal() {
                ...
                Price = new Italbytz.Meal.Abstractions.Price() { Students = 1.1, Employees = 2.1, Pupils = 3.1, Others = 4.1 },
                Allergens = Allergens.Eggs,
                Additives = Additives.FlavorEnhancer,
